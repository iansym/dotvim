...
syn keyword jspDirName contained include page taglib template
...
syn keyword jspCommandName contained not or and if else isa foreach in reverse call break continue
